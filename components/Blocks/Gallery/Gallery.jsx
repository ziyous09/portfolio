...
//     return (
//         <section className={styles.section} ref={container} id="nfts">
//             <Blobs type={'v2'} classVariable={`${styles.blob}`}/>
//             <Container>
//                 <header className={styles.header}>
//                     <Title color={'white'}><span>My</span> NFTs <br/></Title>
//                     <FancyButton theme='button-1' target="_blank" link={commonConfig.social.opensea}>View on Opensea</FancyButton>
//                 </header>
//             </Container>
