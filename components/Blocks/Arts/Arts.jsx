...
//     return (
//         <section className={styles.section} ref={container} id="arts">
//             <Blobs type={'v2'} classVariable={`${styles.blob}`}/>
//             <Container>
//                 <header className={styles.header}>
//                     <Title color={'white'}><span>Digital</span> <br />Artworks </Title>
//                     <FancyButton theme='button-1' target="_blank" link={commonConfig.social.page}>View on Instagram</FancyButton>
//                 </header>
//             </Container>
